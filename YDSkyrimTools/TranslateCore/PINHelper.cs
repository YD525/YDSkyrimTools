...
namespace YDSkyrimTools.TranslateCore
{
    public class PINHelper
    {
        ...
        private static string AESKey = "[21/*YUEDin..g;]";
        ...
        public static string Encrypt(string Text, string sKey = "52508")
        {
        ...
        /// <param name="sKey"></param>
        /// <returns></returns>
        public static string Decrypt(string Text, string sKey = "52508")
        {
            if (Text == null) return "ERROR";
            try
            {
